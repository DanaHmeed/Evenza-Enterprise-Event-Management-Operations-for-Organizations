      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          {step !== "complete" ? (
            ...
            <>
              ...
              <p
                style={{ fontSize: "14px", color: t.textSecondary, margin: 0 }}
              >
        ...
        {step === "new-password" && (
          <form onSubmit={handleSetPassword}>
            ...
            {password.length > 0 && (
              <div
                style={{ display: "flex", gap: "4px", marginBottom: "22px" }}
              >
                {[1, 2, 3, 4].map((level) => (
                  <div
                    key={level}
        ...
        {step === "complete" && (
          <div style={{ textAlign: "center", paddingTop: "8px" }}>
            <Loader2
              size={18}
              className="animate-spin"
              style={{ color: t.accent, margin: "0 auto" }}
            />
          </div>
        )}
      </div>
