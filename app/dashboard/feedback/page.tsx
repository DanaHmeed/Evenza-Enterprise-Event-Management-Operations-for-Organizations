...
export default function OrganizerFeedbackPage() {
  ...
  // ONE request — no N+1, server-side pagination
    ...
    <div style={{ fontFamily: t.sans }}>
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: t.textMuted, marginTop: "4px" }}>
          Reviews from your event attendees.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <OrganizerEmpty
          ...
          message="No feedback yet. Reviews will appear here after events."
        />
      ) : (
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: "11px", color: t.textFaint, flexShrink: 0 }}>
                ...
                {expanded && (
                  <div style={{ padding: "0 20px 16px", borderTop: `1px solid ${t.borderLight}`, paddingTop: "16px" }}>
                    ...
                    <p
                      style={{
                        fontSize: "14px",
                        color: fb.comment ? t.textSecondary : t.textFaint,
